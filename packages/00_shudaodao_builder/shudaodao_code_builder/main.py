...
if __name__ == "__main__":
    ...
    config = GeneratorConfig(
        ...
        # db_url="sqlite:////Users/lf_shao/GitHub/SmartShudao/shudaodao/database/auth_user.db",
        # 鉴权用的角色(默认 schema_name)
        output_auth_role_name=None,
        # 实体模型: 是否输出 schema 标签
        output_schema_to_entity=True,
        # 路由路径: 一般不用设置，默认用 schema，如果数据库不支持 schema 建议设置
        # output_router_path="shudaodao_aaa",
        # 路由模型: 获取数据源    来自 xxx.yaml - storage - database - name: Core Common Generate 定义
